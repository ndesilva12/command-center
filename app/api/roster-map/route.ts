...
async function scrapeTeamRoster(teamId: string, expectedName: string): Promise<Team | null> {
  try {
    ...
    const teamName = $('h1.ClubhouseHeader__Name').text().trim() || 
                     ...
                     $('.TeamHeader__Name--short').text().trim() ||
                     $('title').text().split(' Roster')[0].replace(' Men\'s Basketball', '').trim();
...
// CORRECTED ESPN Team IDs - verified individually
const TEAMS: { id: string; name: string; conference: string }[] = [
  ...
  { id: "152", name: "NC State", conference: "ACC" },
  { id: "154", name: "Wake Forest", conference: "ACC" },
  { id: "228", name: "Clemson", conference: "ACC" },
  { id: "103", name: "Boston College", conference: "ACC" },
  { id: "52", name: "Florida State", conference: "ACC" },
  { id: "59", name: "Georgia Tech", conference: "ACC" },
  { id: "97", name: "Louisville", conference: "ACC" },
  { id: "2390", name: "Miami", conference: "ACC" },
  { id: "87", name: "Notre Dame", conference: "ACC" },
  { id: "221", name: "Pittsburgh", conference: "ACC" },
  { id: "2567", name: "SMU", conference: "ACC" },
  { id: "183", name: "Syracuse", conference: "ACC" },
  { id: "24", name: "Stanford", conference: "ACC" },
  { id: "258", name: "Virginia", conference: "ACC" },
  { id: "259", name: "Virginia Tech", conference: "ACC" },
  { id: "25", name: "California", conference: "ACC" },
  
  // Big Ten
  { id: "356", name: "Illinois", conference: "Big Ten" },
  { id: "84", name: "Indiana", conference: "Big Ten" },
  { id: "2294", name: "Iowa", conference: "Big Ten" },
  { id: "120", name: "Maryland", conference: "Big Ten" },
  ...
  { id: "2483", name: "Oregon", conference: "Big Ten" },
  { id: "213", name: "Penn State", conference: "Big Ten" },
  { id: "2509", name: "Purdue", conference: "Big Ten" },
  { id: "164", name: "Rutgers", conference: "Big Ten" },
  { id: "26", name: "UCLA", conference: "Big Ten" },
  { id: "30", name: "USC", conference: "Big Ten" },
  { id: "264", name: "Washington", conference: "Big Ten" },
  { id: "275", name: "Wisconsin", conference: "Big Ten" },
  
  // SEC
  { id: "333", name: "Alabama", conference: "SEC" },
  { id: "8", name: "Arkansas", conference: "SEC" },
  { id: "2", name: "Auburn", conference: "SEC" },
  ...
  { id: "344", name: "Mississippi State", conference: "SEC" },
  { id: "142", name: "Missouri", conference: "SEC" },
  { id: "145", name: "Ole Miss", conference: "SEC" },
  { id: "201", name: "Oklahoma", conference: "SEC" },
  { id: "2579", name: "South Carolina", conference: "SEC" },
  { id: "2633", name: "Tennessee", conference: "SEC" },
  { id: "251", name: "Texas", conference: "SEC" },
  { id: "245", name: "Texas A&M", conference: "SEC" },
  { id: "238", name: "Vanderbilt", conference: "SEC" },
  
  // Big 12
  { id: "12", name: "Arizona", conference: "Big 12" },
  { id: "9", name: "Arizona State", conference: "Big 12" },
  { id: "239", name: "Baylor", conference: "Big 12" },
  { id: "252", name: "BYU", conference: "Big 12" },
  { id: "2132", name: "Cincinnati", conference: "Big 12" },
  { id: "38", name: "Colorado", conference: "Big 12" },
  { id: "248", name: "Houston", conference: "Big 12" },
  { id: "66", name: "Iowa State", conference: "Big 12" },
  { id: "2305", name: "Kansas", conference: "Big 12" },
  { id: "2306", name: "Kansas State", conference: "Big 12" },
  { id: "197", name: "Oklahoma State", conference: "Big 12" },
  { id: "2628", name: "TCU", conference: "Big 12" },
  { id: "2641", name: "Texas Tech", conference: "Big 12" },
  { id: "2116", name: "UCF", conference: "Big 12" },
  { id: "254", name: "Utah", conference: "Big 12" },
  { id: "277", name: "West Virginia", conference: "Big 12" },
  
  // Big East
  { id: "41", name: "UConn", conference: "Big East" },
  { id: "156", name: "Creighton", conference: "Big East" },
  { id: "305", name: "DePaul", conference: "Big East" },
  { id: "46", name: "Georgetown", conference: "Big East" },
  { id: "269", name: "Marquette", conference: "Big East" },
  { id: "2507", name: "Providence", conference: "Big East" },
  { id: "2550", name: "Seton Hall", conference: "Big East" },
  { id: "2608", name: "St. John's", conference: "Big East" },
  { id: "222", name: "Villanova", conference: "Big East" },
...
export async function GET(req: NextRequest) {
  try {
    ...
    if (action === "roster" && teamId) {
      // Find the expected team name
      const teamInfo = TEAMS.find(t => t.id === teamId);
      const expectedName = teamInfo?.name || `Team ${teamId}`;
      
      const team = await scrapeTeamRoster(teamId, expectedName);
  ...
  try {
    ...
    const results = await Promise.all(
      teamIds.slice(0, 5).map(id => {
        ...
        return scrapeTeamRoster(id, teamInfo?.name || `Team ${id}`);
      })
    );
